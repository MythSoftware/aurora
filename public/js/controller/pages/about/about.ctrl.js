auroraApp.controller('AboutCtrl', function($scope, $controller) {
  ...
  $scope.aboutmessage = 'Aurora is an open source project to help citizens become better informed regarding food safety and food recalls affecting their area. Aurora is designed to present the user with up-to-date data about food recalls by state. This application presents open FDA data to potential users that want to know about food recalls in their area. It also includes features to search for and organize food recalls as well as populating a map based on the number of food recalls per state.'
